...
export const metadata: Metadata = {
  title: "Surjith's | Personal Portfolio",
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      bg-gray-50 text-gray-950 relative h-[5000px] pt-28 sm:pt-36`}>
        <div className=" absolute top-[-6rem] right-[11rem] h-[31.25rem] w-[31.25rem]
         rounded-full blur-[10rem] sm:w-[68.75rem]"></div>
         <div className=" absolute top-[-1rem] -z-10 left-[-35rem] h-[50rem] w-[31.25rem]
